...
| 버전 | 날짜 | 주요 내용 |
|---|---|---|
| [v0.9.5](https://github.com/neushya/Utub/releases/tag/v0.9.5) | 2026-08-23 | 결함 수정 — "내 소리 유지" ON에도 내비 안내 시 덕킹되던 문제 (시스템 자동 덕킹 옵트아웃 방식 전환) |
...
| [v0.10.0](https://github.com/neushya/Utub/releases/tag/v0.10.0) | 2026-08-31 | 채널 정보·댓글 · 네이티브 검색(웹 검색 자동 전환) · 라이브 타임시프트 · 영상 제스처(탭/더블탭) · 알림 탭 열기 · 공용 서명 키 |
| v0.9.2~0.9.5 | 2026-08-22~24 | 결함 수정(딤오프·뒤로가기·내 소리 유지·Tmap 덕킹) · 검색 back 규칙 |
