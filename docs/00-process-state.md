...
**1차 MVP 안정화 + 2차 개선 진행 중** — v0.2.0 릴리즈 (2026-08-19)
...
1. **⑦ 전체화면** (docs/09 — 준비 절반 완료: configChanges 선언됨, 설계 문서화됨)
2. **⑥ 영상 미니플레이어** (docs/09 — VideoMiniPlayerBar 설계 문서화됨)
3. 수동 통합테스트 잔여 항목 (docs/07 — 이어폰·전화·블루투스·백그라운드 모드)
4. P1 잔여: 취침 타이머 상태 UI 채널, Room 마이그레이션 기반(2차 전 필수), LibraryViewModel 분리
